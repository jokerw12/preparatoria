...
<div class="container">
  <br>
  <a href="#ventana1" class="btn btn-success" data-toggle="modal">Registrar profesor</a> 
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form action="registro_profesor.php" method="post">
           ...
           <p>
              <label for="name">RFC</label>
                   <input class="form-control" id="name" type="number" name="rfc" required="required" placeholder="Ingresa RFC">
            </p>
